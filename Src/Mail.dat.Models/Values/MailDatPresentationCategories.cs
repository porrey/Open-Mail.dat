...
namespace Mail.dat
{
	...
	public class MailDatPresentationCategories : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "C", FileExtension = "hdr", Description = "Consolidated Internal Copal Job with MLOCR and Conventional Presort", FieldCode = "HDR-1154", FieldName = "MailDatPresentationCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "E", FileExtension = "hdr", Description = "Consolidated External Copal Job with MLOCR and Conventional Presort", FieldCode = "HDR-1154", FieldName = "MailDatPresentationCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "I", FileExtension = "hdr", Description = "Informed Delivery", FieldCode = "HDR-1154", FieldName = "MailDatPresentationCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "M", FileExtension = "hdr", Description = "MLOCR", FieldCode = "HDR-1154", FieldName = "MailDatPresentationCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "N", FileExtension = "hdr", Description = "Single Piece", FieldCode = "HDR-1154", FieldName = "MailDatPresentationCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "P", FileExtension = "hdr", Description = "Conventional Presort", FieldCode = "HDR-1154", FieldName = "MailDatPresentationCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "R", FileExtension = "hdr", Description = "Certificate of Mailing", FieldCode = "HDR-1154", FieldName = "MailDatPresentationCategory" });
		}
	}
}