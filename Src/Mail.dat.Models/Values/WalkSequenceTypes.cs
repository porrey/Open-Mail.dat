...
namespace Mail.dat
{
	...
	public class WalkSequenceTypes : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "R", FileExtension = "wsr", Description = "Residential", FieldCode = "WSR-1101", FieldName = "WalkSequenceType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "T", FileExtension = "wsr", Description = "Total", FieldCode = "WSR-1101", FieldName = "WalkSequenceType" });
		}
	}
}