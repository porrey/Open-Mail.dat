...
namespace Mail.dat
{
	...
	public class PeriodicalAdTreatments : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "B", FileExtension = "cpt", Description = "Ad % not counted, CPT weight added to base piece", FieldCode = "CPT-1138", FieldName = "PeriodicalAdTreatment" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "N", FileExtension = "cpt", Description = "Not applicable", FieldCode = "CPT-1138", FieldName = "PeriodicalAdTreatment" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "S", FileExtension = "cpt", Description = "Carries own Ad Percentage", FieldCode = "CPT-1138", FieldName = "PeriodicalAdTreatment" });
		}
	}
}