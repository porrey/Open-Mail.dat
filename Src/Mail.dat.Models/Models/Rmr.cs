...
namespace Mail.dat
{
	...
	[MaildatFile(Version = "24-1", Revision = "1.6", Extension = "rmr", File = "Referenceable Mail Record", Summary = "Reference-able Mail to provide digital content at the piece or version level.", Description = "Reference-able Mail to provide digital content at the piece or version level.", LineLength = 311, ClosingCharacter = "#")]
	[MaildatFile(Version = "25-1", Revision = "0.6", Extension = "rmr", File = "Referenceable Mail Record", Summary = "Reference-able Mail to provide digital content at the piece or version level.", Description = "Reference-able Mail to provide digital content at the piece or version level. Records identify digital campaigns and enhances capabilities of the USPS Informed Delivery program.", LineLength = 311, ClosingCharacter = "#")]
	[MaildatFile(Version = "26-1", Revision = "0.1", Extension = "rmr", File = "Referenceable Mail Record", Summary = "Reference-able Mail to provide digital content at the piece or version level.", Description = "Reference-able Mail to provide digital content at the piece or version level. Records identify digital campaigns and enhances capabilities of the USPS Informed Delivery program.", LineLength = 311, ClosingCharacter = "#")]
	[MaildatImport(Order = 22, Version = "23-1")]
	[MaildatImport(Order = 22, Version = "24-1")]
	[MaildatImport(Order = 22, Version = "25-1")]
	[MaildatImport(Order = 22, Version = "26-1")]
	...
	public partial class Rmr : MaildatEntity, IRmr
	{
		...
		[MaildatField(Version = "26-1", Extension = "rmr", FieldCode = "RMR-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "(Zero fill prior to numeric, if numeric only). See Header File’s Job Id.", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		[MaildatField(Version = "26-1", Extension = "rmr", FieldCode = "RMR-1002", FieldName = "RMR ID", Start = 9, Length = 22, Required = true, Key = true, DataType = "A/N", Description = "Key field, same ID data/value as the key fields for CPT or PDR, or PBC record that this record should be linked to. One of the following three values can be used: PBC - PBC Unique ID, right justify and zero fill; PDR - Piece ID; CPT - Component ID.", Type = "string", Format = "zfillnumeric", References = "PBC-1002,PDR-1018,CPT-1004")]
		...
		[MaildatField(Version = "26-1", Extension = "rmr", FieldCode = "RMR-1003", FieldName = "RMR ID Type", Start = 31, Length = 1, Required = true, Key = true, DataType = "A/N", Description = "Field to link to a piece through PDR or PBC or to link to a version through CPT. Type of the record (CPT, PDR/PBC) that the RMR ID (this record) represents.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "rmr", FieldCode = "RMR-1009", FieldName = "RMS ID", Start = 32, Length = 8, Required = true, Key = false, DataType = "A/N", Description = "RMS ID of the Campaign Summary record.", Type = "string", Format = "leftjustify", References = "RMS-1002")]
		...
		[MaildatField(Version = "26-1", Extension = "rmr", FieldCode = "RMR-1004", FieldName = "RMR Content Type", Start = 40, Length = 1, Required = true, Key = true, DataType = "A/N", Description = "Field to capture the type of RMR content. RMR content can either be a URL of a media image that is supported by browsers or a target URL that will be placed as a Hyperlink for the media/image.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "rmr", FieldCode = "RMR-1010", FieldName = "CQT Database ID", Start = 41, Length = 8, Required = false, Key = false, DataType = "N", Description = "See Container Quantity File's CQT Database ID definition. Required for RMR ID type of PBC and PDR. Field must be blank for RMR ID type of Component.", Type = "integer", Format = "zfill", References = "CQT-1034")]
		...
		[MaildatField(Version = "26-1", Extension = "rmr", FieldCode = "RMR-1005", FieldName = "RMR Value", Start = 49, Length = 250, Required = false, Key = false, DataType = "A/N", Description = "Value/Content URL for the Referenceable Mail media or target/HREF document (could be a webpage, or image/media driven by the RMR Content Type field); Leave BLANK if piece wishes to be Opt out of Real Mail Program with RMR Content Type of O, else the field is required.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "rmr", FieldCode = "RMR-1008", FieldName = "RMR Template Code", Start = 299, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "RMR Template Code, one of many templates provided by Postal Service, Possible values can be A through Z.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "rmr", FieldCode = "RMR-1011", FieldName = "Reserve", Start = 300, Length = 10, Required = false, Key = false, DataType = "A/N", Description = "Reserved for future use.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "rmr", FieldCode = "RMR-2000", FieldName = "RMR Record Status", Start = 310, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "O, D, I, U.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "rmr", FieldCode = "RMR-9999", FieldName = "Closing Character", Start = 311, Length = 1, Required = true, Key = false, DataType = "", Description = "Must be the # sign.", Type = "closing", Format = "leftjustify")]
