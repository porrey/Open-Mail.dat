...
namespace Mail.dat
{
	...
	[MaildatFile(Version = "24-1", Revision = "1.6", Extension = "cqt", File = "Container Quantity Record", Summary = "Quantity/rates per 3 or 5 digit in each container.", Description = "Quantity/rates per 3 or 5 digit in each container.", LineLength = 86, ClosingCharacter = "#")]
	[MaildatFile(Version = "25-1", Revision = "0.6", Extension = "cqt", File = "Container Quantity Record", Summary = "Quantity/rates per 3 or 5 digit in each container.", Description = "Quantity/rates per 3 or 5 digit in each container.", LineLength = 86, ClosingCharacter = "#")]
	[MaildatFile(Version = "26-1", Revision = "0.1", Extension = "cqt", File = "Container Quantity Record", Summary = "Quantity/rates per 3 or 5 digit in each container.", Description = "Quantity/rates per 3 or 5 digit in each container.", LineLength = 87, ClosingCharacter = "#")]
	[MaildatImport(Order = 9, Version = "23-1")]
	[MaildatImport(Order = 9, Version = "24-1")]
	[MaildatImport(Order = 9, Version = "25-1")]
	[MaildatImport(Order = 9, Version = "26-1")]
	...
	public partial class Cqt : MaildatEntity, ICqt
	{
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "(Zero fill prior to numeric, if numeric only). See Header File’s Job Id.", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1034", FieldName = "CQT Database ID", Start = 9, Length = 8, Required = true, Key = true, DataType = "N", Description = "Mail.dat® Container Quantity unique number, used to link Mail.dat® CQT and PQT (and PDR) files. Must be mutually exclusive across a Job ID. All non-Key fields in the CQT records should be used to force new records; thus requiring a new CQT ID. It is permitted to have multiple records with all of their fields the same (except the CQT Database ID). It is also permitted to merge records when their fields are the same.", Type = "integer", Format = "zfill")]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1006", FieldName = "Container ID", Start = 17, Length = 6, Required = true, Key = false, DataType = "N", Description = "", Type = "integer", Format = "zfill", References = "CSM-1006")]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1007", FieldName = "3 Digit / 5 Digit Container Division", Start = 23, Length = 5, Required = true, Key = false, DataType = "A/N", Description = "3 or 5 Digit representing a portion or all of the pieces within the container. The 3 or 5 Digit represents those pieces within the container to a single 3 or 5 Digit; not presuming this set of pieces to be all of those going to the destination of the container. For example: Carrier Route Sack is described in one 3 Digit or 5 Digit Container Quantity Record; however, likely multiple records required to describe a Residual tray. there is generally no finer Zone or Destination Entry discrimination necessary. The exceptions for the preceding cases are when there is either: 1) A value representing DDU in field CQT - 1105 for the respective CQT record 2) When the CQT record represents a portion of a 5-Digit Scheme package. 3) For all Package Services CQT records. 4) A 5 Digit ZIP Code is required for products where zoning is determined at a 5-Digit level. In those cited cases, the 3 Digit / 5 Digit field for that container must have 5-Digit detail. Left Justify the 3 Digit; if applicable. The user can make divisions as appropriate to meet the USPS reporting needs. Only US Postal Service and Canada Post mail should have 3- or 5-byte values, all others see following. 3 Digit or 5 Digit Division as necessary. Example: US = (99999_), or (888___) CANADIAN = (A1A___), Left Justify 3 Digit (1C, 2C & 3C use 3 Digit Division; generate additional 5 Digit records, if a DDU in position 49 of .CSM or if record is a 5 Digit Scheme Package or Container ) (4C use 5 Digit Division). In the event that no postal code is available, then the following default 2-position alphas are to be used: Default if no ZIP or Postal Code: Left Justify; Space Added: US = USA CA = Canada MX = Mexico FOR = Foreign Mail: use ISO3166 (2 position alpha Country Code) International: Use ISO3166 (2 position alpha Country Code).", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1003", FieldName = "Mail Piece Unit ID", Start = 28, Length = 5, Required = true, Key = false, DataType = "A/N", Description = "This ID will be used by the computer controlled equipment at the mailing facility to manufacture the specific binding parts for this make-up within this particular mailing. Any Mail Piece Unit exists within a specific Segment. Therefore, Segment/MPU is mutually exclusive. MPU alone is not unique. Must have some value, even if single edition.", Type = "string", Format = "zfillnumeric", References = "MPU-1003")]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1101", FieldName = "Zone", Start = 33, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "Note: Refer to USPS DMM, USPS Notice 123, USPS Postage Statements, USPS Mail.dat Technical guide for more information.", Type = "enum", Format = "leftjustify")]
		...
		/// more information.
		/// </summary>
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1114", FieldName = "Non-Destination Entry Zone", Start = 34, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "Note: Refer to USPS DMM, USPS Notice 123, USPS Postage Statements, USPS Mail.dat Technical Guide for more information.", Type = "enum", Format = "leftjustify")]
		[Column("NonDestinationEntryZone", Order = 8, TypeName = "TEXT")]
		[MaxLength(1)]
		[AllowedValues("A", "B", "C", "D", "N")]
		[Comment("CQT-1114")]
		[TypeConverter(typeof(MaildatEnumConverter))]
		[MaildatValues(typeof(NonDestinationEntryZones))]
		[MaildatVersions("26-1")]
		public string NonDestinationEntryZone { get; set; }
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1105", FieldName = "Destination Entry", Start = 35, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[Column("DestinationEntry", Order = 9, TypeName = "TEXT")]
		[Required]
		[MaxLength(1)]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1008", FieldName = "Rate Category", Start = 36, Length = 2, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[Column("RateCategory", Order = 10, TypeName = "TEXT")]
		[Required]
		[MaxLength(2)]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1009", FieldName = "Barcode Discount Or Surcharge Indicator", Start = 38, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "For Standard Mail that is not sorted to 5-digit there is a surcharge for machinable or nonstandard parcels that are not barcoded.", Type = "enum", Format = "leftjustify")]
		[Column("BarcodeDiscountOrSurchargeIndicator", Order = 11, TypeName = "TEXT")]
		[Required]
		[MaxLength(1)]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1010", FieldName = "Periodicals: Sub/ Non-Sub/ Requester Indicator", Start = 39, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "Applicable to Periodicals.", Type = "enum", Format = "leftjustify")]
		[Column("PeriodicalsSubNonSubRequesterIndicator", Order = 12, TypeName = "TEXT")]
		[Required]
		[MaxLength(1)]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1011", FieldName = "Periodicals: Not County/In County", Start = 40, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "Applicable to Periodicals.", Type = "enum", Format = "leftjustify")]
		[Column("PeriodicalsNotCountyInCounty", Order = 13, TypeName = "TEXT")]
		[Required]
		[MaxLength(1)]
		[AllowedValues("I", "N", "O")]
		[Comment("CQT-1011")]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1102", FieldName = "Number of Copies", Start = 41, Length = 8, Required = true, Key = false, DataType = "N", Description = "Total copies within the specified 3 or 5 digit of this record within the specific container.", Type = "integer", Format = "zfill")]
		[Column("NumberOfCopies", Order = 14, TypeName = "INTEGER")]
		[Required]
		[Comment("CQT-1102")]
		[TypeConverter(typeof(MaildatIntegerConverter))]
		[MaildatVersions("23-1", "24-1", "25-1", "26-1")]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1103", FieldName = "Number of Pieces", Start = 49, Length = 8, Required = true, Key = false, DataType = "N", Description = "Total pieces within the specified 3 or 5 digit of this record within the specific container. (Number of Pieces may be less than number of Copies in some Periodicals or Package Service mailings.).", Type = "integer", Format = "zfill")]
		[Column("NumberOfPieces", Order = 15, TypeName = "INTEGER")]
		[Required]
		[Comment("CQT-1103")]
		[TypeConverter(typeof(MaildatIntegerConverter))]
		[MaildatVersions("23-1", "24-1", "25-1", "26-1")]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1107", FieldName = "Periodicals Co-Palletization Discount Indicator", Start = 57, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "Value is set if new co-palletized piece; does not mean piece qualifies for rate.", Type = "enum", Format = "leftjustify")]
		[Column("PeriodicalsCoPalletizationDiscountIndicator", Order = 16, TypeName = "TEXT")]
		[Required]
		[MaxLength(1)]
		[AllowedValues("N", "Y")]
		[Comment("CQT-1107")]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1111", FieldName = "Container Charge Allocation", Start = 58, Length = 7, Required = false, Key = false, DataType = "N", Description = "Proportion, rounded This field is to be used for denoting the proportion of cost of its container that it's carrying.", Type = "decimal", Format = "zfill", Precision = 6)]
		[Column("ContainerChargeAllocation", Order = 17, TypeName = "NUMERIC")]
		[Precision(6)]
		[Comment("CQT-1111")]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1112", FieldName = "Service Level Indicator", Start = 65, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[Column("ServiceLevelIndicator", Order = 18, TypeName = "TEXT")]
		[MaxLength(1)]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1113", FieldName = "Simplified Address Indicator", Start = 66, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[Column("SimplifiedAddressIndicator", Order = 19, TypeName = "TEXT")]
		[MaxLength(1)]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-2000", FieldName = "CQT Record Status", Start = 67, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "O, D, I, U.", Type = "enum", Format = "leftjustify")]
		[Column("CqtRecordStatus", Order = 20, TypeName = "TEXT")]
		[Required]
		[MaxLength(1)]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-1106", FieldName = "Reserve", Start = 68, Length = 19, Required = false, Key = false, DataType = "A/N", Description = "Reserved for future use.", Type = "string", Format = "leftjustify")]
		[Column("ReserveCqt1106", Order = 21, TypeName = "TEXT")]
		[MaxLength(19)]
		[Comment("CQT-1106")]
		[TypeConverter(typeof(MaildatStringConverter))]
		[MaildatVersions("23-1", "24-1", "25-1", "26-1")]
		...
		[MaildatField(Version = "26-1", Extension = "cqt", FieldCode = "CQT-9999", FieldName = "Closing Character", Start = 87, Length = 1, Required = true, Key = false, DataType = "", Description = "Must be the # sign.", Type = "closing", Format = "leftjustify")]
		[Column("ClosingCharacter", Order = 22, TypeName = "TEXT")]
		[Required]
		[MaxLength(1)]
		[AllowedValues("#")]
		[Comment("CQT-9999")]
		...
		protected override Task<ILoadError[]> OnImportDataAsync(string version, int fileLineNumber, ReadOnlySpan<byte> line)
		{
			...
			this.NonDestinationEntryZone = line.ParseForImport<Cqt, string>(version, p => p.NonDestinationEntryZone, returnValue);
		...
		protected override void OnExportData(string version, Span<byte> buffer, int width, Encoding encoding)
		{
			...
			this.NonDestinationEntryZone.FormatForExport<Cqt, string>(version, p => p.NonDestinationEntryZone, buffer, encoding);
