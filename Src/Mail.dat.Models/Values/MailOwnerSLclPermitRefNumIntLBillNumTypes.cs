...
namespace Mail.dat
{
	...
	public class MailOwnersLclPermitRefNumIntlBillNumTypes : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "G", FileExtension = "mpa", Description = "Gov't - Fed (using Permit)", FieldCode = "MPA-1108", FieldName = "MailOwnersLclPermitRefNumIntlBillNumType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "H", FileExtension = "mpa", Description = "Government Meter", FieldCode = "MPA-1108", FieldName = "MailOwnersLclPermitRefNumIntlBillNumType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "M", FileExtension = "mpa", Description = "Meter", FieldCode = "MPA-1108", FieldName = "MailOwnersLclPermitRefNumIntlBillNumType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "P", FileExtension = "mpa", Description = "Permit", FieldCode = "MPA-1108", FieldName = "MailOwnersLclPermitRefNumIntlBillNumType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "S", FileExtension = "mpa", Description = "Stamp", FieldCode = "MPA-1108", FieldName = "MailOwnersLclPermitRefNumIntlBillNumType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "V", FileExtension = "mpa", Description = "Virtual Reference Number", FieldCode = "MPA-1108", FieldName = "MailOwnersLclPermitRefNumIntlBillNumType" });
		}
	}
}