...
namespace Mail.dat
{
	...
	public class ContainerStatuses : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = " ", FileExtension = "csm", Description = "Not closed", FieldCode = "CSM-1124", FieldName = "ContainerStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "C", FileExtension = "csm", Description = "Cancel", FieldCode = "CSM-1124", FieldName = "ContainerStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "D", FileExtension = "csm", Description = "Delete", FieldCode = "CSM-1124", FieldName = "ContainerStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "P", FileExtension = "csm", Description = "Preliminary postage statement", FieldCode = "CSM-1124", FieldName = "ContainerStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "R", FileExtension = "csm", Description = "Ready to pay", FieldCode = "CSM-1124", FieldName = "ContainerStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "T", FileExtension = "csm", Description = "Transportation Information Updated", FieldCode = "CSM-1124", FieldName = "ContainerStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "X", FileExtension = "csm", Description = "Paid", FieldCode = "CSM-1124", FieldName = "ContainerStatus" });
		}
	}
}