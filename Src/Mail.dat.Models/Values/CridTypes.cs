...
namespace Mail.dat
{
	...
	public class CridTypes : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "M", FileExtension = "epd", Description = "Move Update Supplier", FieldCode = "EPD-1003", FieldName = "CridType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "U", FileExtension = "epd", Description = "Piece Uniqueness Manager", FieldCode = "EPD-1003", FieldName = "CridType" });
		}
	}
}