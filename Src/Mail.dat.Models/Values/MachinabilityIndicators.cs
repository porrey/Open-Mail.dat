...
namespace Mail.dat
{
	...
	public class MachinabilityIndicators : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "N", FileExtension = "mpu", Description = "Not Machinable", FieldCode = "MPU-1123", FieldName = "MachinabilityIndicator" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "U", FileExtension = "mpu", Description = "Flat Machinable on UFSM 1000", FieldCode = "MPU-1123", FieldName = "MachinabilityIndicator" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "Y", FileExtension = "mpu", Description = "Machinable", FieldCode = "MPU-1123", FieldName = "MachinabilityIndicator" });
		}
	}
}