...
namespace Mail.dat
{
	...
	public class HeaderHistoryStatuses : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "C", FileExtension = "hdr", Description = "Current", FieldCode = "HDR-1148", FieldName = "HeaderHistoryStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "H", FileExtension = "hdr", Description = "History", FieldCode = "HDR-1148", FieldName = "HeaderHistoryStatus" });
		}
	}
}