...
namespace Mail.dat
{
	...
	public class ComponentPeriodicalAdPercentageStatuses : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "F", FileExtension = "cpt", Description = "Final", FieldCode = "CPT-1109", FieldName = "ComponentPeriodicalAdPercentageStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "N", FileExtension = "cpt", Description = "None Given", FieldCode = "CPT-1109", FieldName = "ComponentPeriodicalAdPercentageStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "P", FileExtension = "cpt", Description = "Pending", FieldCode = "CPT-1109", FieldName = "ComponentPeriodicalAdPercentageStatus" });
		}
	}
}