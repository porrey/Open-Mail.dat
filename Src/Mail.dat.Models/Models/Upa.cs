...
namespace Mail.dat
{
	...
	[MaildatFile(Version = "24-1", Revision = "1.6", Extension = "upa", File = "Un-Coded Parcels Address", Summary = "Un-coded parcels address record (linked to PDR).", Description = "Un-coded parcels address record (linked to PDR). Un-Coded Parcel Address file: records addresses for the un-coded parcels. (Links with .pdr ONLY).", LineLength = 135, ClosingCharacter = "#")]
	[MaildatFile(Version = "25-1", Revision = "0.6", Extension = "upa", File = "Un-Coded Parcels Address", Summary = "Un-coded parcels address record (linked to PDR).", Description = "Un-coded parcels address record (linked to PDR). Un-Coded Parcel Address file: records addresses for the un-coded parcels. (Links with .pdr ONLY).", LineLength = 135, ClosingCharacter = "#")]
	[MaildatFile(Version = "26-1", Revision = "0.1", Extension = "upa", File = "Un-Coded Parcels Address", Summary = "Un-coded parcels address record (linked to PDR).", Description = "Un-coded parcels address record (linked to PDR). Un-Coded Parcel Address file: records addresses for the un-coded parcels. (Links with .pdr ONLY).", LineLength = 135, ClosingCharacter = "#")]
	[MaildatImport(Order = 20, Version = "23-1")]
	[MaildatImport(Order = 20, Version = "24-1")]
	[MaildatImport(Order = 20, Version = "25-1")]
	[MaildatImport(Order = 20, Version = "26-1")]
	...
	public partial class Upa : MaildatEntity, IUpa
	{
		...
		[MaildatField(Version = "26-1", Extension = "upa", FieldCode = "UPA-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "(Zero fill prior to numeric, if numeric only). See Header File’s Job Id.", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		[MaildatField(Version = "26-1", Extension = "upa", FieldCode = "UPA-1018", FieldName = "Piece ID", Start = 9, Length = 22, Required = true, Key = true, DataType = "A/N", Description = "Unique ID of individual piece within mailing.", Type = "string", Format = "zfillnumeric", References = "PDR-1018")]
		...
		[MaildatField(Version = "26-1", Extension = "upa", FieldCode = "UPA-1034", FieldName = "CQT Database ID", Start = 31, Length = 8, Required = true, Key = false, DataType = "N", Description = "", Type = "integer", Format = "zfill", References = "CQT-1034")]
		...
		[MaildatField(Version = "26-1", Extension = "upa", FieldCode = "UPA-1102", FieldName = "Address", Start = 39, Length = 47, Required = false, Key = false, DataType = "A/N", Description = "Address line to be used for population of shipping services file.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "upa", FieldCode = "UPA-1103", FieldName = "Additional Address", Start = 86, Length = 47, Required = false, Key = false, DataType = "A/N", Description = "Address 2 line to be used for Secondary Address or Urbanization information.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "upa", FieldCode = "UPA-2000", FieldName = "UPA Record Status", Start = 133, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "O, D, I, U.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "upa", FieldCode = "UPA-1120", FieldName = "Reserve", Start = 134, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "Reserved for future use.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "upa", FieldCode = "UPA-9999", FieldName = "Closing Character", Start = 135, Length = 1, Required = true, Key = false, DataType = "", Description = "Must be the # sign.", Type = "closing", Format = "leftjustify")]
