...
namespace Mail.dat
{
	...
	public class SfbRecordStatuses : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "D", FileExtension = "sfb", Description = "Delete", FieldCode = "SFB-2000", FieldName = "SfbRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "I", FileExtension = "sfb", Description = "Insert", FieldCode = "SFB-2000", FieldName = "SfbRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "O", FileExtension = "sfb", Description = "Original", FieldCode = "SFB-2000", FieldName = "SfbRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "U", FileExtension = "sfb", Description = "Update", FieldCode = "SFB-2000", FieldName = "SfbRecordStatus" });
		}
	}
}