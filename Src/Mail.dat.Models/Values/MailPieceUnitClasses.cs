...
namespace Mail.dat
{
	...
	public class MailPieceUnitClasses : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "1", FileExtension = "mpu", Description = "First Class", FieldCode = "MPU-1111", FieldName = "MailPieceUnitClass" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "2", FileExtension = "mpu", Description = "Periodicals", FieldCode = "MPU-1111", FieldName = "MailPieceUnitClass" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "3", FileExtension = "mpu", Description = "Std Mail", FieldCode = "MPU-1111", FieldName = "MailPieceUnitClass" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "4", FileExtension = "mpu", Description = "Pkg Services", FieldCode = "MPU-1111", FieldName = "MailPieceUnitClass" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "5", FileExtension = "mpu", Description = "Per Pending", FieldCode = "MPU-1111", FieldName = "MailPieceUnitClass" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "9", FileExtension = "mpu", Description = "Other", FieldCode = "MPU-1111", FieldName = "MailPieceUnitClass" });
		}
	}
}