...
namespace Mail.dat
{
	...
	[MaildatFile(Version = "24-1", Revision = "1.6", Extension = "snr", File = "Seed Name Record", Summary = "Detail for each tracking program address.", Description = "Detail for each tracking program address. Identifies package/container of seed names within the presort.", LineLength = 160, ClosingCharacter = "#")]
	[MaildatFile(Version = "25-1", Revision = "0.6", Extension = "snr", File = "Seed Name Record", Summary = "Detail for each tracking program address.", Description = "Detail for each tracking program address. Identifies package/container of seed names within the presort.", LineLength = 160, ClosingCharacter = "#")]
	[MaildatFile(Version = "26-1", Revision = "0.1", Extension = "snr", File = "Seed Name Record", Summary = "Detail for each tracking program address.", Description = "Detail for each tracking program address. Identifies package/container of seed names within the presort.", LineLength = 160, ClosingCharacter = "#")]
	[MaildatImport(Order = 12, Version = "23-1")]
	[MaildatImport(Order = 12, Version = "24-1")]
	[MaildatImport(Order = 12, Version = "25-1")]
	[MaildatImport(Order = 12, Version = "26-1")]
	...
	public partial class Snr : MaildatEntity, ISnr
	{
		...
		[MaildatField(Version = "26-1", Extension = "snr", FieldCode = "SNR-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "(Zero fill prior to numeric, if numeric only). See Header File’s Job Id.", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		[MaildatField(Version = "26-1", Extension = "snr", FieldCode = "SNR-1006", FieldName = "Container ID", Start = 9, Length = 6, Required = true, Key = true, DataType = "N", Description = "", Type = "integer", Format = "zfill", References = "CSM-1006")]
		...
		[MaildatField(Version = "26-1", Extension = "snr", FieldCode = "SNR-1012", FieldName = "Package ID", Start = 15, Length = 6, Required = true, Key = true, DataType = "A/N", Description = "The unique code for this package within this container.", Type = "string", Format = "zfillnumeric", References = "PQT-1012")]
		...
		[MaildatField(Version = "26-1", Extension = "snr", FieldCode = "SNR-1003", FieldName = "Mail Piece Unit ID", Start = 21, Length = 5, Required = true, Key = true, DataType = "A/N", Description = "", Type = "string", Format = "zfillnumeric", References = "MPU-1003")]
		...
		[MaildatField(Version = "26-1", Extension = "snr", FieldCode = "SNR-1016", FieldName = "Seed Name ID", Start = 26, Length = 20, Required = true, Key = true, DataType = "A/N", Description = "Since this file is only necessary to be used in the event that a list of specific and documented names for a tracking program, then this field is populated with the supplied ID for each specific name/address. Therefore, there will be one Seed Name Record for each supplied seed name to be tracked. General seed lists (example: all managers at the catalog) will not require feedback of this nature from the list house.", Type = "string", Format = "zfillnumeric")]
		...
		[MaildatField(Version = "26-1", Extension = "snr", FieldCode = "SNR-1017", FieldName = "Version Key Code", Start = 46, Length = 20, Required = true, Key = true, DataType = "A/N", Description = "Derived from original seed information. As with the Seed Name ID, this information is derived from the supplied name/address/record data.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "snr", FieldCode = "SNR-1101", FieldName = "Seed Name Received Date", Start = 66, Length = 8, Required = false, Key = false, DataType = "N", Default = "00010101", Description = "The date the seed agent received the mail piece.", Type = "date", Format = "YYYYMMDD")]
		...
		[MaildatField(Version = "26-1", Extension = "snr", FieldCode = "SNR-1104", FieldName = "Seed Type", Start = 74, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "snr", FieldCode = "SNR-1105", FieldName = "Piece Barcode", Start = 75, Length = 11, Required = false, Key = false, DataType = "A/N", Description = "5-Digit, 9-Digit, 11-Digit routing ZIP barcode numeric.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "snr", FieldCode = "SNR-1106", FieldName = "Reported Seed Condition", Start = 86, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "The condition of the seed as received by a seed reporter.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "snr", FieldCode = "SNR-1108", FieldName = "IM™ Barcode", Start = 87, Length = 34, Required = false, Key = false, DataType = "A/N", Description = "To be used for IM™ barcode only. This field not to be used to specify routing ZIP Barcode alone; use the Piece Barcode field identified above for routing ZIP barcode alone. The IM™ Barcode shall remain unique for 45 days.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "snr", FieldCode = "SNR-1110", FieldName = "User Option Field", Start = 121, Length = 20, Required = false, Key = false, DataType = "A/N", Description = "Available for customer data for unique user application.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "snr", FieldCode = "SNR-2000", FieldName = "SNR Record Status", Start = 141, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "O, D, I, U.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "snr", FieldCode = "SNR-1103", FieldName = "Reserve", Start = 142, Length = 18, Required = false, Key = false, DataType = "A/N", Description = "Reserved for future use.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "snr", FieldCode = "SNR-9999", FieldName = "Closing Character", Start = 160, Length = 1, Required = true, Key = false, DataType = "", Description = "Must be the # sign.", Type = "closing", Format = "leftjustify")]
