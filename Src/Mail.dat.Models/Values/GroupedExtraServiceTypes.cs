...
namespace Mail.dat
{
	...
	public class GroupedExtraServiceTypes : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = " ", FileExtension = "mpu", Description = "Not Specified", FieldCode = "MPU-1133", FieldName = "GroupedExtraServiceType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "B", FileExtension = "mpu", Description = "Certificate of Bulk Mailing (3606-D)", FieldCode = "MPU-1133", FieldName = "GroupedExtraServiceType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "F", FileExtension = "mpu", Description = "Certificate of Mailing Firm Book (3665)", FieldCode = "MPU-1133", FieldName = "GroupedExtraServiceType" });
		}
	}
}