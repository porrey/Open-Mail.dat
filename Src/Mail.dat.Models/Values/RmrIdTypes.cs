...
namespace Mail.dat
{
	...
	public class RmrIdTypes : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "B", FileExtension = "rmr", Description = "PBC", FieldCode = "RMR-1003", FieldName = "RmrIdType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "C", FileExtension = "rmr", Description = "CPT", FieldCode = "RMR-1003", FieldName = "RmrIdType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "P", FileExtension = "rmr", Description = "PDR", FieldCode = "RMR-1003", FieldName = "RmrIdType" });
		}
	}
}