...
namespace Mail.dat
{
	...
	public class MpaRecordStatuses : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "D", FileExtension = "mpa", Description = "Delete", FieldCode = "MPA-2000", FieldName = "MpaRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "I", FileExtension = "mpa", Description = "Insert", FieldCode = "MPA-2000", FieldName = "MpaRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "O", FileExtension = "mpa", Description = "Original", FieldCode = "MPA-2000", FieldName = "MpaRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "U", FileExtension = "mpa", Description = "Update", FieldCode = "MPA-2000", FieldName = "MpaRecordStatus" });
		}
	}
}