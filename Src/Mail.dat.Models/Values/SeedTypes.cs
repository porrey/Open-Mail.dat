...
namespace Mail.dat
{
	...
	public class SeedTypes : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "B", FileExtension = "snr", Description = "Both R + C", FieldCode = "SNR-1104", FieldName = "SeedType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "C", FileExtension = "snr", Description = "Standard Confirm", FieldCode = "SNR-1104", FieldName = "SeedType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "R", FileExtension = "snr", Description = "Traditional Response Seed", FieldCode = "SNR-1104", FieldName = "SeedType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "S", FileExtension = "snr", Description = "Smart Confirm", FieldCode = "SNR-1104", FieldName = "SeedType" });
		}
	}
}