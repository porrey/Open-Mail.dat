...
namespace Mail.dat
{
	...
	public class FullServiceParticipationIndicators : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = " ", FileExtension = "seg", Description = "None", FieldCode = "SEG-1146", FieldName = "FullServiceParticipationIndicator" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "F", FileExtension = "seg", Description = "Full Service Option", FieldCode = "SEG-1146", FieldName = "FullServiceParticipationIndicator" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "M", FileExtension = "seg", Description = "Mixed(Basic and Full Mixed)", FieldCode = "SEG-1146", FieldName = "FullServiceParticipationIndicator" });
		}
	}
}