...
namespace Mail.dat
{
	...
	public class HostIndicatorOfAdComputations : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = " ", FileExtension = "mcr", Description = "Not Applicable", FieldCode = "MCR-1105", FieldName = "HostIndicatorOfAdComputation" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "N", FileExtension = "mcr", Description = "No", FieldCode = "MCR-1105", FieldName = "HostIndicatorOfAdComputation" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "Y", FileExtension = "mcr", Description = "Yes", FieldCode = "MCR-1105", FieldName = "HostIndicatorOfAdComputation" });
		}
	}
}