...
namespace Mail.dat
{
	...
	public class SfrRecordStatuses : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "D", FileExtension = "sfr", Description = "Delete", FieldCode = "SFR-2000", FieldName = "SfrRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "I", FileExtension = "sfr", Description = "Insert", FieldCode = "SFR-2000", FieldName = "SfrRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "O", FileExtension = "sfr", Description = "Original", FieldCode = "SFR-2000", FieldName = "SfrRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "U", FileExtension = "sfr", Description = "Update", FieldCode = "SFR-2000", FieldName = "SfrRecordStatus" });
		}
	}
}