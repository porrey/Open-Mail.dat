...
namespace Mail.dat
{
	...
	[MaildatFile(Version = "24-1", Revision = "1.6", Extension = "rmb", File = "Referenceable Mail Barcode Record", Summary = "Reference-able Mail Barcode to provide digital content at the piece level outside of the Mail.dat required files and structure.", Description = "Reference-able Mail Barcode to provide digital content at the piece level outside of the Mail.dat required files and structure. Records identify digital campaigns and enhance capabilities of the USPS Informed Delivery  program separate from the required file structure.", LineLength = 316, ClosingCharacter = "#")]
	[MaildatFile(Version = "25-1", Revision = "0.6", Extension = "rmb", File = "Referenceable Mail Barcode Record", Summary = "Reference-able Mail Barcode to provide digital content at the piece level outside of the Mail.dat required files and structure.", Description = "Reference-able Mail Barcode to provide digital content at the piece level outside of the Mail.dat required files and structure. Records identify digital campaigns and enhance capabilities of the USPS Informed Delivery  program separate from the required file structure.", LineLength = 316, ClosingCharacter = "#")]
	[MaildatFile(Version = "26-1", Revision = "0.1", Extension = "rmb", File = "Referenceable Mail Barcode Record", Summary = "Reference-able Mail Barcode to provide digital content at the piece level outside of the Mail.dat required files and structure.", Description = "Reference-able Mail Barcode to provide digital content at the piece level outside of the Mail.dat required files and structure. Records identify digital campaigns and enhance capabilities of the USPS Informed Delivery  program separate from the required file structure.", LineLength = 316, ClosingCharacter = "#")]
	[MaildatImport(Order = 23, Version = "23-1")]
	[MaildatImport(Order = 23, Version = "24-1")]
	[MaildatImport(Order = 23, Version = "25-1")]
	[MaildatImport(Order = 23, Version = "26-1")]
	...
	public partial class Rmb : MaildatEntity, IRmb
	{
		...
		[MaildatField(Version = "26-1", Extension = "rmb", FieldCode = "RMB-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "(Zero fill prior to numeric, if numeric only). See Header File’s Job Id.", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		[MaildatField(Version = "26-1", Extension = "rmb", FieldCode = "RMB-1002", FieldName = "RMS ID", Start = 9, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "Unique ID of individual Campaign.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "rmb", FieldCode = "RMB-1003", FieldName = "Barcode", Start = 17, Length = 34, Required = true, Key = true, DataType = "A/N", Description = "IMb® for Informed Delivery.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "rmb", FieldCode = "RMB-1004", FieldName = "RMB Content Type", Start = 51, Length = 1, Required = true, Key = true, DataType = "A/N", Description = "Field to capture the type of RMB content. RMB content can either be a URL of a media image that is supported by browsers or a target URL that will be placed as a Hyperlink for the media/image. Details of the codes will be available in the USPS Technical Guide for Mail.dat.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "rmb", FieldCode = "RMB-1005", FieldName = "Original Job ID", Start = 52, Length = 8, Required = false, Key = false, DataType = "A/N", Description = "Job ID provided in another mailing job.", Type = "string", Format = "zfillnumeric")]
		...
		[MaildatField(Version = "26-1", Extension = "rmb", FieldCode = "RMB-1006", FieldName = "Original User License Code", Start = 60, Length = 4, Required = false, Key = false, DataType = "A/N", Description = "User License Code provided in another mailing job.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "rmb", FieldCode = "RMB-1007", FieldName = "RMB Value", Start = 64, Length = 250, Required = false, Key = false, DataType = "A/N", Description = "Value/Content URL for the Referenceable Mail media or target/HREF document (could be a webpage, or image/media driven by the RMR Content Type field); Leave BLANK if piece wishes to be Opt out of Real Mail Program with RMR Content Type of O, else the field is required.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "rmb", FieldCode = "RMB-1008", FieldName = "RMB Template Code", Start = 314, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "RMB Template Code, one of many templates provided by Postal Service. Possible values A through Z.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "rmb", FieldCode = "RMB-2000", FieldName = "RMB Record Status", Start = 315, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "O, D, I, U.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "rmb", FieldCode = "RMB-9999", FieldName = "Closing Character", Start = 316, Length = 1, Required = true, Key = false, DataType = "", Description = "Must be the # sign.", Type = "closing", Format = "leftjustify")]
