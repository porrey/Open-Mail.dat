...
namespace Mail.dat
{
	...
	public class MailingAgreementTypes : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = " ", FileExtension = "seg", Description = "Not Applicable", FieldCode = "SEG-1139", FieldName = "MailingAgreementType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "A", FileExtension = "seg", Description = "Alternate Mailing System", FieldCode = "SEG-1139", FieldName = "MailingAgreementType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "B", FileExtension = "seg", Description = "Optional Procedure", FieldCode = "SEG-1139", FieldName = "MailingAgreementType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "D", FileExtension = "seg", Description = "Value Added", FieldCode = "SEG-1139", FieldName = "MailingAgreementType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "E", FileExtension = "seg", Description = "Combined Mail", FieldCode = "SEG-1139", FieldName = "MailingAgreementType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "F", FileExtension = "seg", Description = "Combined and Value Added", FieldCode = "SEG-1139", FieldName = "MailingAgreementType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "G", FileExtension = "seg", Description = "Manifest Mailing Itemized", FieldCode = "SEG-1139", FieldName = "MailingAgreementType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "H", FileExtension = "seg", Description = "Manifest Mailing Batch", FieldCode = "SEG-1139", FieldName = "MailingAgreementType" });
		}
	}
}