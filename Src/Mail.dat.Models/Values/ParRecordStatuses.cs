...
namespace Mail.dat
{
	...
	public class ParRecordStatuses : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "D", FileExtension = "par", Description = "Delete", FieldCode = "PAR-2000", FieldName = "ParRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "I", FileExtension = "par", Description = "Insert", FieldCode = "PAR-2000", FieldName = "ParRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "O", FileExtension = "par", Description = "Original", FieldCode = "PAR-2000", FieldName = "ParRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "U", FileExtension = "par", Description = "Update", FieldCode = "PAR-2000", FieldName = "ParRecordStatus" });
		}
	}
}