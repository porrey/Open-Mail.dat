...
namespace Mail.dat
{
	...
	public class EpdRecordStatuses : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "D", FileExtension = "epd", Description = "Delete", FieldCode = "EPD-2000", FieldName = "EpdRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "I", FileExtension = "epd", Description = "Insert", FieldCode = "EPD-2000", FieldName = "EpdRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "O", FileExtension = "epd", Description = "Original", FieldCode = "EPD-2000", FieldName = "EpdRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "U", FileExtension = "epd", Description = "Update", FieldCode = "EPD-2000", FieldName = "EpdRecordStatus" });
		}
	}
}