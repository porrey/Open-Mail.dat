...
namespace Mail.dat
{
	...
	public class CreditDebitIndicators : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "C", FileExtension = "par", Description = "Credit", FieldCode = "PAR-1104", FieldName = "CreditDebitIndicator" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "D", FileExtension = "par", Description = "Debit", FieldCode = "PAR-1104", FieldName = "CreditDebitIndicator" });
		}
	}
}