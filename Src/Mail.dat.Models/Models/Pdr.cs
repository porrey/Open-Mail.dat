...
namespace Mail.dat
{
	...
	[MaildatFile(Version = "24-1", Revision = "1.6", Extension = "pdr", File = "Piece Detail Record", Summary = "Quantity, rate, weight, and destination per piece (manifest).", Description = "Quantity, rate, weight, and destination per piece (manifest). Provides piece level detail required of full service mailings; has additional capabilities beyond the Piece Barcode file; when used instead of the Piece Barcode file, acts as an extension of the PQT file.", LineLength = 138, ClosingCharacter = "#")]
	[MaildatFile(Version = "25-1", Revision = "0.6", Extension = "pdr", File = "Piece Detail Record", Summary = "Quantity, rate, weight, and destination per piece (manifest).", Description = "Quantity, rate, weight, and destination per piece (manifest). Provides piece level detail required of full service mailings; has additional capabilities beyond the Piece Barcode file; when used instead of the Piece Barcode file, acts as an extension of the PQT file.", LineLength = 138, ClosingCharacter = "#")]
	[MaildatFile(Version = "26-1", Revision = "0.1", Extension = "pdr", File = "Piece Detail Record", Summary = "Quantity, rate, weight, and destination per piece (manifest).", Description = "Quantity, rate, weight, and destination per piece (manifest). Provides piece level detail required of full service mailings; has additional capabilities beyond the Piece Barcode file; when used instead of the Piece Barcode file, acts as an extension of the PQT file.", LineLength = 138, ClosingCharacter = "#")]
	[MaildatImport(Order = 14, Version = "23-1")]
	[MaildatImport(Order = 14, Version = "24-1")]
	[MaildatImport(Order = 14, Version = "25-1")]
	[MaildatImport(Order = 14, Version = "26-1")]
	...
	public partial class Pdr : MaildatEntity, IPdr
	{
		...
		[MaildatField(Version = "26-1", Extension = "pdr", FieldCode = "PDR-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "(Zero fill prior to numeric, if numeric only). See Header File’s Job Id.", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		[MaildatField(Version = "26-1", Extension = "pdr", FieldCode = "PDR-1034", FieldName = "CQT Database ID", Start = 9, Length = 8, Required = true, Key = false, DataType = "N", Description = "", Type = "integer", Format = "zfill", References = "CQT-1034")]
		...
		[MaildatField(Version = "26-1", Extension = "pdr", FieldCode = "PDR-1012", FieldName = "Package ID", Start = 17, Length = 6, Required = true, Key = false, DataType = "A/N", Description = "The unique code for this package within this container. note: may use XXXXXX, if no packages created.).", Type = "string", Format = "zfillnumeric")]
		...
		[MaildatField(Version = "26-1", Extension = "pdr", FieldCode = "PDR-1018", FieldName = "Piece ID", Start = 23, Length = 22, Required = true, Key = true, DataType = "A/N", Description = "Unique ID of individual piece within mailing.", Type = "string", Format = "zfillnumeric")]
		...
		[MaildatField(Version = "26-1", Extension = "pdr", FieldCode = "PDR-1108", FieldName = "Piece Barcode", Start = 45, Length = 11, Required = false, Key = false, DataType = "A/N", Description = "Numeric values of the applicable  5-Digit, 9-Digit, or  11-Digit Barcode for the specific piece If specifying a 5-digit or 9-digit barcode, then leave the rest of the field blank.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "pdr", FieldCode = "PDR-1114", FieldName = "Line-Of-Travel Sequence Number", Start = 56, Length = 4, Required = false, Key = false, DataType = "N", Description = "Specific piece's L.O.T.-relative sequence number within ZIP+4.", Type = "integer", Format = "zfill")]
		...
		[MaildatField(Version = "26-1", Extension = "pdr", FieldCode = "PDR-1115", FieldName = "Line-Of-Travel Seq. Direction Code", Start = 60, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "Piece's LOT-relative code, if carrier walk its block-face ascending order.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "pdr", FieldCode = "PDR-1116", FieldName = "Walk Sequence Number", Start = 61, Length = 5, Required = false, Key = false, DataType = "N", Description = "Relative Walk Sequence number describing ranking within the carrier's actual delivery sequence.", Type = "integer", Format = "zfill")]
		...
		[MaildatField(Version = "26-1", Extension = "pdr", FieldCode = "PDR-1117", FieldName = "Wasted or Shortage Piece Indicator", Start = 66, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "pdr", FieldCode = "PDR-1127", FieldName = "Move Update Method", Start = 114, Length = 1, Required = false, Key = false, DataType = "N", Description = "This field is used to identify Move Update method at the postage statement level.", Type = "enum", Format = "zfill")]
		...
		[MaildatField(Version = "26-1", Extension = "pdr", FieldCode = "PDR-1129", FieldName = "ACS Key Line Data", Start = 115, Length = 16, Required = false, Key = false, DataType = "A/N", Description = "Remove formatting characters as needed to make the data fit in this sixteen byte field.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "pdr", FieldCode = "PDR-1130", FieldName = "Carrier Route", Start = 131, Length = 4, Required = false, Key = false, DataType = "A/N", Description = "USPS Carrier Route code.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "pdr", FieldCode = "PDR-1132", FieldName = "MID in IMb® is Move Update Supplier", Start = 136, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "pdr", FieldCode = "PDR-2000", FieldName = "PDR Record Status", Start = 137, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "O, D, I, U.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "pdr", FieldCode = "PDR-9999", FieldName = "Closing Character", Start = 138, Length = 1, Required = true, Key = false, DataType = "", Description = "Must be the # sign.", Type = "closing", Format = "leftjustify")]
