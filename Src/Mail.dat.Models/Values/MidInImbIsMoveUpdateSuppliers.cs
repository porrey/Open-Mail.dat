...
namespace Mail.dat
{
	...
	public class MidInImbIsMoveUpdateSuppliers : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = " ", FileExtension = "pbc", Description = "No", FieldCode = "PBC-1119", FieldName = "MidInImbIsMoveUpdateSupplier" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "Y", FileExtension = "pbc", Description = "Yes", FieldCode = "PBC-1119", FieldName = "MidInImbIsMoveUpdateSupplier" });
		}
	}
}