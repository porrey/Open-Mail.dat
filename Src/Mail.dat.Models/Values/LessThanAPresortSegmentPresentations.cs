...
namespace Mail.dat
{
	...
	public class LessThanAPresortSegmentPresentations : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "N", FileExtension = "seg", Description = "Full Presort", FieldCode = "SEG-1145", FieldName = "LessThanAPresortSegmentPresentation" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "Y", FileExtension = "seg", Description = "Partial", FieldCode = "SEG-1145", FieldName = "LessThanAPresortSegmentPresentation" });
		}
	}
}