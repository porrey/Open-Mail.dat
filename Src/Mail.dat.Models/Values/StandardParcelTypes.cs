...
namespace Mail.dat
{
	...
	public class StandardParcelTypes : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = " ", FileExtension = "cpt", Description = "Not a Standard Parcel", FieldCode = "CPT-1156", FieldName = "StandardParcelType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "F", FileExtension = "cpt", Description = "Not a Marketing parcel", FieldCode = "CPT-1156", FieldName = "StandardParcelType" });
			this.Add(new MaildatValue() { Version = "25-1", Key = "H", FileExtension = "cpt", Description = "Heavy Printed Matter", FieldCode = "CPT-1156", FieldName = "StandardParcelType" });
			this.Add(new MaildatValue() { Version = "26-1", Key = "H", FileExtension = "cpt", Description = "Heavy Printed Matter", FieldCode = "CPT-1156", FieldName = "StandardParcelType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "M", FileExtension = "cpt", Description = "Marketing", FieldCode = "CPT-1156", FieldName = "StandardParcelType" });
			this.Add(new MaildatValue() { Version = "25-1", Key = "P", FileExtension = "cpt", Description = "Reserve", FieldCode = "CPT-1156", FieldName = "StandardParcelType" });
