...
namespace Mail.dat
{
	...
	public class SnrRecordStatuses : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "D", FileExtension = "snr", Description = "Delete", FieldCode = "SNR-2000", FieldName = "SnrRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "I", FileExtension = "snr", Description = "Insert", FieldCode = "SNR-2000", FieldName = "SnrRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "O", FileExtension = "snr", Description = "Original", FieldCode = "SNR-2000", FieldName = "SnrRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "U", FileExtension = "snr", Description = "Update", FieldCode = "SNR-2000", FieldName = "SnrRecordStatus" });
		}
	}
}