...
namespace Mail.dat
{
	...
	public class McrRecordStatuses : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "D", FileExtension = "mcr", Description = "Delete", FieldCode = "MCR-2000", FieldName = "McrRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "I", FileExtension = "mcr", Description = "Insert", FieldCode = "MCR-2000", FieldName = "McrRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "O", FileExtension = "mcr", Description = "Original", FieldCode = "MCR-2000", FieldName = "McrRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "U", FileExtension = "mcr", Description = "Update", FieldCode = "MCR-2000", FieldName = "McrRecordStatus" });
		}
	}
}