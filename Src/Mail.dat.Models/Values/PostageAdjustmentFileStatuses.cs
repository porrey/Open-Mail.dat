...
namespace Mail.dat
{
	...
	public class PostageAdjustmentFileStatuses : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "C", FileExtension = "hdr", Description = "Change Individual Records", FieldCode = "HDR-1147", FieldName = "PostageAdjustmentFileStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "D", FileExtension = "hdr", Description = "Delete Entire File", FieldCode = "HDR-1147", FieldName = "PostageAdjustmentFileStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "N", FileExtension = "hdr", Description = "None Transmitted", FieldCode = "HDR-1147", FieldName = "PostageAdjustmentFileStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "O", FileExtension = "hdr", Description = "Original", FieldCode = "HDR-1147", FieldName = "PostageAdjustmentFileStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "R", FileExtension = "hdr", Description = "Replace Entire File", FieldCode = "HDR-1147", FieldName = "PostageAdjustmentFileStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "U", FileExtension = "hdr", Description = "Update individual Records", FieldCode = "HDR-1147", FieldName = "PostageAdjustmentFileStatus" });
		}
	}
}