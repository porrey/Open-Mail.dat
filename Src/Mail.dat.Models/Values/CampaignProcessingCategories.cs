...
namespace Mail.dat
{
	...
	public class CampaignProcessingCategories : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "CD", FileExtension = "rms", Description = "Card", FieldCode = "RMS-1014", FieldName = "CampaignProcessingCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "CM", FileExtension = "rms", Description = "Custom Mail", FieldCode = "RMS-1014", FieldName = "CampaignProcessingCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "FL", FileExtension = "rms", Description = "Flat", FieldCode = "RMS-1014", FieldName = "CampaignProcessingCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "IR", FileExtension = "rms", Description = "Nonstandard Parcel", FieldCode = "RMS-1014", FieldName = "CampaignProcessingCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "LT", FileExtension = "rms", Description = "Letter", FieldCode = "RMS-1014", FieldName = "CampaignProcessingCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "MP", FileExtension = "rms", Description = "Machinable Parcel", FieldCode = "RMS-1014", FieldName = "CampaignProcessingCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "PF", FileExtension = "rms", Description = "Parcel, First Class", FieldCode = "RMS-1014", FieldName = "CampaignProcessingCategory" });
