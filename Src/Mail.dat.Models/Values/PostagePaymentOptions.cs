...
namespace Mail.dat
{
	...
	public class PostagePaymentOptions : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "B", FileExtension = "mpa", Description = "Billing", FieldCode = "MPA-1109", FieldName = "PostagePaymentOption" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "C", FileExtension = "mpa", Description = "CPP", FieldCode = "MPA-1109", FieldName = "PostagePaymentOption" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "D", FileExtension = "mpa", Description = "Debit", FieldCode = "MPA-1109", FieldName = "PostagePaymentOption" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "O", FileExtension = "mpa", Description = "Other", FieldCode = "MPA-1109", FieldName = "PostagePaymentOption" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "T", FileExtension = "mpa", Description = "CAPS/EPS", FieldCode = "MPA-1109", FieldName = "PostagePaymentOption" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "V", FileExtension = "mpa", Description = "PVDS", FieldCode = "MPA-1109", FieldName = "PostagePaymentOption" });
		}
	}
}