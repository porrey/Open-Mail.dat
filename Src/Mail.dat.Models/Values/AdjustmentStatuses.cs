...
namespace Mail.dat
{
	...
	public class AdjustmentStatuses : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = " ", FileExtension = "par", Description = "Not Closed", FieldCode = "PAR-1108", FieldName = "AdjustmentStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "C", FileExtension = "par", Description = "Cancel", FieldCode = "PAR-1108", FieldName = "AdjustmentStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "P", FileExtension = "par", Description = "Preliminary Postage Statement", FieldCode = "PAR-1108", FieldName = "AdjustmentStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "R", FileExtension = "par", Description = "Ready To Pay", FieldCode = "PAR-1108", FieldName = "AdjustmentStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "T", FileExtension = "par", Description = "Transportation Information Update, if after R", FieldCode = "PAR-1108", FieldName = "AdjustmentStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "X", FileExtension = "par", Description = "Paid", FieldCode = "PAR-1108", FieldName = "AdjustmentStatus" });
		}
	}
}