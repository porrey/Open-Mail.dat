...
namespace Mail.dat
{
	...
	public class WsrRecordStatuses : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "D", FileExtension = "wsr", Description = "Delete", FieldCode = "WSR-2000", FieldName = "WsrRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "I", FileExtension = "wsr", Description = "Insert", FieldCode = "WSR-2000", FieldName = "WsrRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "O", FileExtension = "wsr", Description = "Original", FieldCode = "WSR-2000", FieldName = "WsrRecordStatus" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "U", FileExtension = "wsr", Description = "Update", FieldCode = "WSR-2000", FieldName = "WsrRecordStatus" });
		}
	}
}