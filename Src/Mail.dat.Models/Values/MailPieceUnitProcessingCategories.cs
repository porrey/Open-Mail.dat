...
namespace Mail.dat
{
	...
	public class MailPieceUnitProcessingCategories : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "CD", FileExtension = "mpu", Description = "Card", FieldCode = "MPU-1113", FieldName = "MailPieceUnitProcessingCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "CM", FileExtension = "mpu", Description = "Custom Mail", FieldCode = "MPU-1113", FieldName = "MailPieceUnitProcessingCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "FL", FileExtension = "mpu", Description = "Flat", FieldCode = "MPU-1113", FieldName = "MailPieceUnitProcessingCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "IR", FileExtension = "mpu", Description = "Nonstandard Parcels", FieldCode = "MPU-1113", FieldName = "MailPieceUnitProcessingCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "LT", FileExtension = "mpu", Description = "Letter", FieldCode = "MPU-1113", FieldName = "MailPieceUnitProcessingCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "MP", FileExtension = "mpu", Description = "Machinable Parcel", FieldCode = "MPU-1113", FieldName = "MailPieceUnitProcessingCategory" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "PF", FileExtension = "mpu", Description = "Parcel, First Class", FieldCode = "MPU-1113", FieldName = "MailPieceUnitProcessingCategory" });
		}
	}
}