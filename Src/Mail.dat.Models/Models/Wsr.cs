...
namespace Mail.dat
{
	...
	[MaildatFile(Version = "24-1", Revision = "1.6", Extension = "wsr", File = "Walk Sequence Record", Summary = "Detail for each Walk Sequence prepared Carrier Route.", Description = "Detail for each Walk Sequence prepared Carrier Route. Provide detail to verify Saturation or High Density mailings.", LineLength = 50, ClosingCharacter = "#")]
	[MaildatFile(Version = "25-1", Revision = "0.6", Extension = "wsr", File = "Walk Sequence Record", Summary = "Detail for each Walk Sequence prepared Carrier Route.", Description = "Detail for each Walk Sequence prepared Carrier Route. Provide detail to verify Saturation or High Density mailings.", LineLength = 50, ClosingCharacter = "#")]
	[MaildatFile(Version = "26-1", Revision = "0.1", Extension = "wsr", File = "Walk Sequence Record", Summary = "Detail for each Walk Sequence prepared Carrier Route.", Description = "Detail for each Walk Sequence prepared Carrier Route. Provide detail to verify Saturation or High Density mailings.", LineLength = 50, ClosingCharacter = "#")]
	[MaildatImport(Order = 11, Version = "23-1")]
	[MaildatImport(Order = 11, Version = "24-1")]
	[MaildatImport(Order = 11, Version = "25-1")]
	[MaildatImport(Order = 11, Version = "26-1")]
	...
	public partial class Wsr : MaildatEntity, IWsr
	{
		...
		[MaildatField(Version = "26-1", Extension = "wsr", FieldCode = "WSR-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "(Zero fill prior to numeric, if numeric only). See Header File’s Job Id.", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		[MaildatField(Version = "26-1", Extension = "wsr", FieldCode = "WSR-1002", FieldName = "Segment ID", Start = 9, Length = 4, Required = true, Key = true, DataType = "A/N", Description = "See Segment File's Segment ID definition.", Type = "string", Format = "zfillnumeric", References = "SEG-1002")]
		...
		[MaildatField(Version = "26-1", Extension = "wsr", FieldCode = "WSR-1013", FieldName = "Package ZIP Code", Start = 13, Length = 6, Required = true, Key = true, DataType = "A/N", Description = "The 5-digit, 3-digit, 6-character or 6-alpha destination of the package defined in the record. Left Justify. See package Quantity File's Package Zip Code field's definition.", Type = "string", Format = "leftjustify", References = "PQT-1013")]
		...
		[MaildatField(Version = "26-1", Extension = "wsr", FieldCode = "WSR-1014", FieldName = "Package CR Number", Start = 19, Length = 4, Required = true, Key = true, DataType = "A/N", Description = "Example: C999 or 9999 example: C999, R999, B999, H999 as applicable.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "wsr", FieldCode = "WSR-1104", FieldName = "Walk Sequence Database Date", Start = 34, Length = 8, Required = true, Key = false, DataType = "N", Description = "The date of the database from which the walk sequence was secured.", Type = "date", Format = "YYYYMMDD")]
		...
		[MaildatField(Version = "26-1", Extension = "wsr", FieldCode = "WSR-2000", FieldName = "WSR Record Status", Start = 42, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "O, D, I, U.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "wsr", FieldCode = "WSR-1105", FieldName = "Reserve", Start = 43, Length = 7, Required = false, Key = false, DataType = "A/N", Description = "Reserved for future use.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "wsr", FieldCode = "WSR-9999", FieldName = "Closing Character", Start = 50, Length = 1, Required = true, Key = false, DataType = "", Description = "Must be the # sign.", Type = "closing", Format = "leftjustify")]
