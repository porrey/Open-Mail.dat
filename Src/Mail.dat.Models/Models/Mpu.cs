...
namespace Mail.dat
{
	...
	[MaildatFile(Version = "24-1", Revision = "1.6", Extension = "mpu", File = "Mail Piece Unit", Summary = "A common code for set of components in a mail piece.", Description = "A common code for set of components in a mail piece.", LineLength = 193, ClosingCharacter = "#")]
	[MaildatFile(Version = "25-1", Revision = "0.6", Extension = "mpu", File = "Mail Piece Unit", Summary = "A common code for set of components in a mail piece.", Description = "A common code for set of components in a mail piece.", LineLength = 193, ClosingCharacter = "#")]
	[MaildatFile(Version = "26-1", Revision = "0.1", Extension = "mpu", File = "Mail Piece Unit", Summary = "A common code for set of components in a mail piece.", Description = "A common code for set of components in a mail piece.", LineLength = 193, ClosingCharacter = "#")]
	[MaildatImport(Order = 3, Version = "23-1")]
	[MaildatImport(Order = 3, Version = "24-1")]
	[MaildatImport(Order = 3, Version = "25-1")]
	[MaildatImport(Order = 3, Version = "26-1")]
	...
	public partial class Mpu : MaildatEntity, IMpu
	{
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "(Zero fill prior to numeric, if numeric only). See Header File’s Job Id.", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1002", FieldName = "Segment ID", Start = 9, Length = 4, Required = true, Key = true, DataType = "A/N", Description = "", Type = "string", Format = "zfillnumeric", References = "SEG-1002")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1003", FieldName = "Mail Piece Unit ID", Start = 13, Length = 5, Required = true, Key = true, DataType = "A/N", Description = "Must have some value, even if single edition. This ID will be used by the computer controlled equipment at the mailing facility to manufacture the specific binding parts for this make-up within this particular mailing. Any Mail Piece Unit exists within a specific Segment. Therefore, Segment/MPU is mutually exclusive. MPU alone is not unique.", Type = "string", Format = "zfillnumeric")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1101", FieldName = "Mail Piece Unit Name", Start = 18, Length = 12, Required = true, Key = false, DataType = "A/N", Description = "The name used to identify a specific marketing version within a list, bind and distribution environment. This name may be on-going as a description from issue to issue, as opposed to the job to job alpha and/or numeric Selective Bind Code that will control the binding machine. The Mail Piece Unit Name, more traditionally in Periodicals, may be a meaningful identifier; such as S-S NW Metro. Whether in Periodicals or other classes, the MPU Name field is a defined location where downstream users can find the MPU's meaningful Name for this job, regardless of the arbitrary MPU ID. If, as may often be the case in non-Periodical, there is no benefit derived from special naming then the Book Make-up Name can be the same as the MPU ID. The MPU Name will be the source for mail owner's name on Postage Payment forms or their electronic equivalents. Suggested convention for carrying the identity of the base book: - Example MPU Name Value:Exxxxxxx_BRO -- E (hard coded) stands for edition; -- xxxxxxx (only as many as necessary) represents base book edition; -- _ (underline) separates edition & suffix; -- B/R/O (solo or BO or RO) --- B = Bill, R = Renewal, O= Other H = Periodicals Ride-Along - Additional Examples: E9711COM_B or E1997S_O or E01_RO.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1102", FieldName = "Mail Piece Unit Description", Start = 30, Length = 30, Required = false, Key = false, DataType = "A/N", Description = "This is a unique name or code for each specific version being created within this mailing. However, as a differentiation from the Mail Piece Unit Name, this may be a meaningful descriptor of a broader significance than just this mailing. Therefore, this field is an opportunity to have absolute, as well as of relative, information in this record. This offers information for enhanced quality assurance and reduced error. For example: A periodical has a Metro Northwest Superspot edition that is run every issue. Therefore, the Mail Piece Unit ID to drive the machine in the bindery might be B for one issue and Q a month later. However, the Mail Piece Unit Name would always be S-S NW Metro and the Mail Piece Unit Description would always be Metro Northwest Superspot A 3C campaign may not have repeating market target names; or they may. So, the Mail Piece Unit IDs for a mailing may be A, B, and C. For that campaign, the MPU Descriptions may be A, B, and C., or the MPU Descriptions could be RHF, RHS, and RHT, if those were meaningful codes carrying over from one job to another. The originator of the Mail.dat® file, as agreed by receiving mailing facilities, can choose to the finest level of detail in the preceding two fields or simply clone that which is in the Mail Piece Unit ID field.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1103", FieldName = "Mail Piece Unit - Weight", Start = 60, Length = 6, Required = true, Key = false, DataType = "N", Description = "Weight of a copy in pounds, rounded. Presort Facilities default to 1 ounce, if Metered Mail.", Type = "decimal", Format = "zfill", Precision = 4)]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1104", FieldName = "MPU - Weight: Source", Start = 66, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "Source of Piece Weight.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1105", FieldName = "MPU - Weight: Status", Start = 67, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "Status of weight data.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1106", FieldName = "Mail Piece Unit - Length", Start = 68, Length = 7, Required = false, Key = false, DataType = "N", Description = "Length of a copy in inches, rounded.", Type = "decimal", Format = "zfill", Precision = 4)]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1107", FieldName = "Mail Piece Unit - Width", Start = 75, Length = 6, Required = false, Key = false, DataType = "N", Description = "Width of a copy in inches, rounded.", Type = "decimal", Format = "zfill", Precision = 4)]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1108", FieldName = "Mail Piece Unit - Thickness", Start = 81, Length = 6, Required = false, Key = false, DataType = "N", Description = "Thickness of a copy in inches.", Type = "decimal", Format = "zfill", Precision = 4)]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1111", FieldName = "Mail Piece Unit - Class", Start = 87, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "The Postal Class of this Mail Piece Unit within Mail.dat.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1112", FieldName = "Mail Piece Unit - Rate Type", Start = 88, Length = 2, Required = true, Key = false, DataType = "A/N", Description = "The special rate type that applies to this Mail Piece Unit.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1128", FieldName = "Rate Schedule", Start = 90, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1113", FieldName = "Mail Piece Unit - Processing Category", Start = 91, Length = 2, Required = true, Key = false, DataType = "A/N", Description = "The processing category for which this Mail Piece Unit is eligible.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1115", FieldName = "MPU Surcharge", Start = 93, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "Surcharges applicable to the this MPU. Regarding Machinability; a single MPU will be used to describe the nature of the mail piece: - The MPU - Surcharge field to indicate overall nature of the piece's physical characteristics. - Two MPUs (and associated CPTs) may be necessary to communicate a mailing, not just CPTs.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1116", FieldName = "Co-Palletization Code", Start = 94, Length = 2, Required = true, Key = false, DataType = "A/N", Description = "Used to differentiate carrier route mail going to the same ZIP and Route that was coded and presorted independently, to allow association with a subset of the Walk Sequence Records (*.wsr). For Co-palletization, it creates an efficient means to differentiate each of the possible job and sub-job entities within a co-palletization set-up. Can also be used to differentiate between simplified and non-simplified addressed pieces when combined in the same job. Populate with 01 for jobs where this additional level of detail is not needed.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1123", FieldName = "Machinability Indicator", Start = 96, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1124", FieldName = "Pre-Denominated Amount", Start = 97, Length = 5, Required = false, Key = false, DataType = "N", Description = "Cents.", Type = "decimal", Format = "zfill", Precision = 1)]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1125", FieldName = "Postage Affixed Type", Start = 102, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1132", FieldName = "Standard Parcel Type", Start = 103, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1129", FieldName = "User Option Field", Start = 104, Length = 20, Required = false, Key = false, DataType = "A/N", Description = "Available for customer data for unique user application.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1130", FieldName = "Move Update Supplier CRID", Start = 124, Length = 12, Required = false, Key = false, DataType = "A/N", Description = "This USPS-assigned id, CRID, will be used to uniquely identify the party responsible for compliance with USPS move update requirements. Only digits 0 - 9 acceptable.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1131", FieldName = "Piece Uniqueness Manager CRID", Start = 136, Length = 12, Required = false, Key = false, DataType = "A/N", Description = "This USPS-assigned id, CRID, will be used to uniquely identify the party responsible for maintaining piece IMb® uniqueness. Left justify, space padded to the right, only digits 0 - 9 acceptable.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-2000", FieldName = "MPU Record Status", Start = 148, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "O, D, I, U.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1133", FieldName = "Grouped Extra Service Type", Start = 149, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "Identifies the type of Grouped Extra Service.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1134", FieldName = "Grouped Extra Service Barcode", Start = 150, Length = 34, Required = false, Key = false, DataType = "A/N", Description = "Identifies IMpb® (Intelligent Mail Package Barcode).", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1135", FieldName = "IMpb® Barcode Construct Code", Start = 184, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "Populate when IMpb® is used. This code identifies which combination of ZIP, MID, and serial number is used in the IMpb®. Industry has agreed that for IMpb®, only PDR is the viable option because it provides the 11 digit Zip code in the Piece Barcode field.", Type = "enum", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-1121", FieldName = "Reserve", Start = 185, Length = 8, Required = false, Key = false, DataType = "A/N", Description = "Reserved for future use.", Type = "string", Format = "leftjustify")]
		...
		[MaildatField(Version = "26-1", Extension = "mpu", FieldCode = "MPU-9999", FieldName = "Closing Character", Start = 193, Length = 1, Required = true, Key = false, DataType = "", Description = "Must be the # sign.", Type = "closing", Format = "leftjustify")]
