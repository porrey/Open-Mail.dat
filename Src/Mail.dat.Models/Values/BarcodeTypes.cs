...
namespace Mail.dat
{
	...
	public class BarcodeTypes : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "E", FileExtension = "sfb", Description = "Extra Barcode", FieldCode = "SFB-1004", FieldName = "BarcodeType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "F", FileExtension = "sfb", Description = "Fee Barcode", FieldCode = "SFB-1004", FieldName = "BarcodeType" });
		}
	}
}