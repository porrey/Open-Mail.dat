...
namespace Mail.dat
{
	...
	public class FormTypes : MaildatValues
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "A", FileExtension = "chr", Description = "PS Form 3606-D (Bulk Certificate of Mailing)", FieldCode = "CHR-1101", FieldName = "FormType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "B", FileExtension = "chr", Description = "PS Form 3665 (Certificate of Mailing)", FieldCode = "CHR-1101", FieldName = "FormType" });
			...
			this.Add(new MaildatValue() { Version = "26-1", Key = "C", FileExtension = "chr", Description = "PS Form 3877 (Firm Book for Accountable Mail)", FieldCode = "CHR-1101", FieldName = "FormType" });
